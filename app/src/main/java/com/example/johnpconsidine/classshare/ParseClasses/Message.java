...
public class Message extends ParseObject {
    ...
    public List getRecipients() { return getList(ParseConstants.RECIPIENT);}
    public void setRecipients(List<String> recipient) { put(ParseConstants.RECIPIENT, recipient);} //only called at the creation of a group
